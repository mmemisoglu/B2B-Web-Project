...
function title(){
    ...
    if($productsef){
        ...
        if($product->rowCount()){
            ...
            $title['img']    = $site."/upload/product/".$prow->urunkapak;
        ...
        if($cat->rowCount()){
            ...
            $title['img']    = $site."/upload/product/".$crow2->katresim;
        ...
        if($cat->rowCount()){
            ...
            $title['img']    = $site."/upload/".$crow->kapak;
        ...
        $title['keyw']   = mb_substr($sitekeyw,0,320,'utf8');
        $title['img']    = $site."/upload/".$sitelogo;
