			...
			<div class="heading-banner-area overlay-bg" style="background: rgba(0, 0, 0, 0) url(<?php echo site;?>/upload/RegisterBanner.webp) no-repeat scroll center center / cover;">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="heading-banner">
								<div class="heading-banner-title">
									<h2>BAYİ GİRİŞ & KAYIT</h2>
								</div>
								<div class="breadcumbs pb-15">
									<ul>
										<li><a href="index.html">Ana Sayfa</a></li>
										<li>BAYİ GİRİŞ & KAYIT</li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="col-lg-6">
								<form action="" method="POST" onsubmit="return false;" id="bloginform">	
									<div class="customer-login text-left">
										...
										<p><a href="<?php echo site."/contact.php"?>" class="text-gray">Şifremi unuttum</a></p>
						...
						<div class="col-lg-6">
							<form action="" method="POST" onsubmit="return false;" id="bregisterform">	
								<div class="customer-login text-left">
									...
									<input type="text" placeholder="Bayi E-mail" name="bmail">
									...
									<button type="submit" id="registerbuton" onclick="registerbutton();" class="button-one submit-button mt-15">Kayıt ol</button>
								</div>	
								</form>				
							</div>
